            ...
            <div class="bg-gray-900" x-data="{ showModal: false, selectedType: '' }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    @foreach([
                        ...
                        <div class="bg-gray-800/50 p-6 rounded-lg">
                            ...
                            <p class="text-white text-4xl font-bold" id="count-{{ str_replace(' ', '-', strtolower($type)) }}">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button 
                            @click="showModal = true; selectedType = 'Hotel'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Hotel
                        </button>
                        <button 
                            @click="showModal = true; selectedType = 'Culinary'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Culinary
                        </button>
                        <button 
                            @click="showModal = true; selectedType = 'Shopping'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Shopping
                        </button>
                        <button 
                            @click="showModal = true; selectedType = 'Entertainment'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Entertainment
                        </button>
                        <button 
                            @click="showModal = true; selectedType = 'Tourist Attraction'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Tourist Attraction
                        </button>
                        <button 
                            @click="showModal = true; selectedType = 'Tour Guide'"
                            class="bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 py-3 rounded-lg transition-colors">
                            Tour Guide
                        </button>
                    </div>
                            ...
                            <div class="relative bg-gray-800 rounded-lg w-full max-w-xl p-6">
                                <form id="projectForm" class="space-y-6" enctype="multipart/form-data" action="{{ route('admin.store') }}" method="POST">
                                    ...
                                    <div class="w-full aspect-video bg-gray-700 relative rounded-lg overflow-hidden cursor-pointer">
                                        ...
                                        <input type="file" name="main_image" accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer" @change="handleMainImageUpload($event)">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-5 gap-4">
                                            @for($i = 0; $i < 5; $i++)
                                            <div class="aspect-square bg-gray-700 relative rounded-lg overflow-hidden cursor-pointer">
                                                ...
                                                <input type="file" name="gallery_images[]" accept="image/*" class="absolute inset-0 opacity-0 cursor-pointer" @change="handleGalleryImageUpload($event, {{ $i }})">
                                            </div>
                                            @endfor
                                        </div>
                                    </div>
