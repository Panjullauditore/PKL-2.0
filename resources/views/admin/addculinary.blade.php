<x-app-layout>
    <div x-data="{ sidebarOpen: true }" class="flex min-h-screen bg-gray-900">
        ...
        <div class="flex-1 min-h-screen bg-gray-900 p-8 mt-7">
            ...
            <!-- Add New Culinary Form -->
            <div class="md:col-span-2 bg-gray-800 rounded-3xl p-8 shadow-sm">
                <div class="space-y-6">
                    <h2 class="text-white text-2xl">Add New Culinary</h2>
                    <form action="{{ route('addculinary.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <!-- Display List of Added Culinaries -->
            <div class="mt-8 bg-gray-800 rounded-3xl p-8 shadow-sm">
                <h2 class="text-white text-2xl mb-4">Culinary List</h2>
                            ...
                            <tr class="border-b border-gray-700">
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex flex-col items-start space-y-2">
                                        <!-- Edit Button -->
                                        <a href="{{ route('addculinary.edit', $culinary->id) }}" class="text-blue-600 hover:text-blue-800 flex items-center gap-2">
