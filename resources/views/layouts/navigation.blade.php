        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('wisata')" :active="request()->routeIs('wisata')" class="text-white">
                        {{ __('Wisata') }}
                    </x-nav-link>
                    <x-nav-link :href="route('kuliner')" :active="request()->routeIs('kuliner')" class="text-white">
                        {{ __('Kuliner') }}
                    </x-nav-link>
                    <x-nav-link :href="route('hotel')" :active="request()->routeIs('hotel')" class="text-white">
                        {{ __('Hotel') }}
                    </x-nav-link>
                </div>
            </div>
