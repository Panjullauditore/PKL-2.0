            ...
            <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="p-8">
                    ...
                    <div class="mt-8 border-t border-gray-700 pt-8">
                        ...
                        <!-- Review Form -->
                        <form id="reviewForm" method="POST" action="{{ route('entertainment.review.store', $place['id']) }}" class="mb-8">
                            @csrf
                    ...
                    <a href="{{ route('entertainment.index') }}" class="inline-block mt-8 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300">
