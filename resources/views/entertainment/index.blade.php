<!-- resources/views/entertainment/index.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Entertainment Semarang') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12 bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($entertainmentPlaces as $place)
                <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('entertainment.show', $loop->index) }}" class="inline-block mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300">
                            View Details
                        </a>
                    </div>
                </div>
