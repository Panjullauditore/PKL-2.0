...
class TouristAttractionController extends Controller
{
    ...
    {
        // Example review data with username
        return [
            0 => [
    ...
    // Display all tourist attractions
    public function index()
    {
        $touristAttractions = $this->getTouristAttractions();  // Fetch tourist attractions data
        return view('tourist-attraction.index', compact('touristAttractions'));  // Pass tourist attractions data to view
    }
